...
of the GameObject objects kept by it.
...
All dynamic/static actors/objects in a GameScene is a GameObject (e.g. background, player, etc).
The method or data structure used by the GameScene to store all GameEntities is up to developers.
Each GameObject contains these methods:
